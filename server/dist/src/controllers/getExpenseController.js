...
const getExpense = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const expenseSumRaw = yield prisma.expenseByCategory.findMany({
            orderBy: {
                date: "desc",
            },
        });
        const expenseCategorySum = expenseSumRaw.map((item) => (Object.assign(Object.assign({}, item), { amount: item.amount.toString() })));
